 ...
 * SumFunction.java
 *
 * Created on 9 de enero de 2004, 18:02
 */
 ...
 * @author  Manolo
 */
public class SumFunction extends elvira.potential.Function {
    ...
    System.out.println("Error: PotValue not implemented in SumFunction!!!!");
    return 0.0;
    }
    ...
    Potential functionAddVariable(Vector potVar, Vector vars) {
         /**@todo: implement this elvira.potential.Function abstract method*/
    System.out.println("Error: functionAddVariable not implemented in SumFunction!!!!");
    ...
    Potential marginalizeFunctionPotential(Vector vars) {
         /**@todo: implement this elvira.potential.Function abstract method*/
    System.out.println("Error: marginalizeFunctionPotential not implemented in SumFunction!!!!");
    return (Potential) null;
    }
    ...
    Potential restrictFunctionToVariable(PotentialFunction inputPot, Configuration conf) {
           /**@todo: implement this elvira.potential.Function abstract method*/
    System.out.println("Error: restrictFunctionToVariable not implemented in SumFunction!!!!");
    return (Potential) null;
    }
