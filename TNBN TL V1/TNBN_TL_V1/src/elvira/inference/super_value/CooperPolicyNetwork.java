...
//	Vector optimalPolicies;
	 ...
	 */
	private void setOptimalPoliciesAndRelationsOfDecisionNodesFrom(IDWithSVNodes id,int methodPropagation,Vector parametersPropagation) {
	 ...
	 */
	private Relation toDeterministicRelation(PotentialTable decisionTableInOriginal){
		Relation newRel;
		Node decisionInNew;
