...
public class MITMetrics extends Metrics {
	...
	for(i=0; i< vars.size(); i++){
	    ...
	    valscore = score(varsXPa);
            System.out.println("score "+varsXPa.toString2()+" "+valscore);

	    sum+=valscore;
	}
        System.out.println("score red"+sum);
	return sum;
    }
  ...
  //this method computes the local score MIT(x,Pa(x))
	...
	//	System.out.println(Arrays.toString(pz.getValues()));
                pz.print();
		...
		System.out.print("probability table of px :\n");
	//	System.out.println(Arrays.toString(px.getValues()));
                px.print();
		...
		dz = pz.entropyPotential();
                ...
                System.out.println("dxz "+ dxz+" dx "+ dx+" dz "+dz);
